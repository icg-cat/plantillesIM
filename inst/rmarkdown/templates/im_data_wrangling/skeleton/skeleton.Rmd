...
## group_by
serveix per agrupar les dades en base a un criteri o variable comuna, i realitzar operacions de càlcul de variables (mutate) o de síntesi de resultats (summarise). Com a tal, `group_by()` no retorna cap resultat visible, sinó un dataframe que internament està agrupat. 
...
llars %>% 
  ...
  # agrupem per lloguer (per diferenciar els dos grups)
  group_by(HH021) %>% 
