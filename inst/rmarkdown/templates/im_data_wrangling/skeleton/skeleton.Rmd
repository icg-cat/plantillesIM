...
Per fer una taula de freqüències (ponderant), podem fer servir la funció `fes_taula()`, que aplica, i simplifica aquest procés: 
...
llars %>% 
  ...
  fes_taula(VI = "HH021", VD = "llar_10k", pes = "HB030")
```
